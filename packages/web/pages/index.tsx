...
const myFont = localFont({
  src: '../components/layouts/RocknRollOne-Regular.ttf',
  weight: '700',
});
        ...
        >
          ...
          >
            ...
            <div className={styles.container}>
              {picArr &&
                Object.keys(picArr).map(key => (
                  <Card
                    key={key}
                    picture={picArr[key]}
                    cardTitle={bookArr[key].substring(
                      0,
                      bookArr[key].length - 3
                    )}
                    cardType={'diary'}
                  ></Card>
                ))}
            ...
            <div className={styles.container}>
              {animePicArr &&
                Object.keys(animePicArr).map(key => (
                  <Card
                    key={key}
                    picture={animePicArr[key]}
                    cardTitle={thinkArr[key].substring(
                      0,
                      thinkArr[key].length - 3
                    )}
                    cardType={'anime'}
                  ></Card>
                ))}
